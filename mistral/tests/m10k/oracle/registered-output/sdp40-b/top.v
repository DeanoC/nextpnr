module top(input clka, clkb, we, re, input [7:0] wa, ra, input [39:0] d, output [39:0] q);
...
.width_b(40), .widthad_b(8), .numwords_b(256), .width_byteena_a(1), .width_byteena_b(1),
...
.address_a(wa),.data_a(d),.wren_a(we),.rden_a(1'b1),.byteena_a(1'b1),.address_b(ra),.q_b(q),.wren_b(1'b0),.rden_b(re),.byteena_b(1'b1),.data_b(40'b0),
