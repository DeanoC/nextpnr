module top(input clka, clkb, we, re, input [8:0] wa, input [7:0] ra,
 input [19:0] d, output [39:0] q);
 ...
 .width_b(40), .widthad_b(8), .numwords_b(256),
 ...
 .address_b(ra), .q_b(q), .wren_b(1'b0), .rden_b(1'b1), .byteena_b(1'b1), .data_b(40'b0),
