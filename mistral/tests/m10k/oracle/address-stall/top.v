module top(input clka, clkb, wea, web, ena, enb, stall_a, stall_b,
 input [9:0] aa, ab, input [9:0] da, db, output [9:0] qa, qb);
 ...
 .clock0(clka), .clock1(clkb), .clocken0(ena), .clocken1(enb),
 ...
 .addressstall_a(stall_a), .addressstall_b(stall_b));
endmodule
