module top(input clka, clkb, we, re, input [8:0] wa, ra, input [19:0] d, output [19:0] q);
...
.width_b(20), .widthad_b(9), .numwords_b(512), .width_byteena_a(1),
...
.address_b(ra),.q_b(q),.wren_b(1'b0),.rden_b(1'b1),.byteena_b(1'b1),.data_b(20'b0),
