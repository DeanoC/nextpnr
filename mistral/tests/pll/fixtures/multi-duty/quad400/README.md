# quad400 asymmetric-duty Quartus reference

Quartus Prime Lite 17.0.2, device `5CSEBA6U23I7`, 50 MHz reference,
25/50/50/100 MHz outputs and 25/50/50/25% duty, direct integer mode, zero phase.
...
M16/N2, VCO400 MHz. Fixed counter placements: output0: C6, divide16, high4/low12, output1: C7, divide8, high4/low4, output2: C5, divide8, high4/low4, output3: C8, divide4, high1/low3.
All odd-divider even-duty enables are off. Full non-counter FPLL settings
match the existing `../../multi/quad400` oracle, including analog and feedback
...
```sh
quartus_sh -t /path/to/fixtures/multi-duty/quad400/oracle.tcl
