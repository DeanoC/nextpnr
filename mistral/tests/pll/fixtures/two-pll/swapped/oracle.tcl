...
close $sdc
set_location_assignment FRACTIONALPLL_X0_Y32_N0 -to {audio_pll|general[0].gpll~FRACTIONAL_PLL}
set_location_assignment FRACTIONALPLL_X0_Y15_N0 -to {video_pll|general[0].gpll~FRACTIONAL_PLL}
set_location_assignment PLLOUTPUTCOUNTER_X0_Y20_N1 -to {video_pll|general[0].gpll~PLL_OUTPUT_COUNTER}
set_location_assignment PLLOUTPUTCOUNTER_X0_Y33_N1 -to {audio_pll|general[0].gpll~PLL_OUTPUT_COUNTER}
export_assignments
project_close
