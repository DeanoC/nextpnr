# dual315 Quartus phase reference

Quartus Prime Lite 17.0.2, device `5CSEBA6U23I7`, 50 MHz reference,
2 outputs at 50 MHz, phases 0/17500 ps, 50% duty,
...
```sh
quartus_sh -t /path/to/phase-45/dual315/oracle.tcl
