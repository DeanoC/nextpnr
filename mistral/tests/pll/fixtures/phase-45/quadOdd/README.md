# quadOdd Quartus phase reference

Quartus Prime Lite 17.0.2, device `5CSEBA6U23I7`, 50 MHz reference,
4 outputs at 50 MHz, phases 0/2500/7500/12500 ps, 50% duty,
...
1/1/3/4, and phase mux presets 0/6/2/6.
...
```sh
quartus_sh -t /path/to/phase-45/quadOdd/oracle.tcl
