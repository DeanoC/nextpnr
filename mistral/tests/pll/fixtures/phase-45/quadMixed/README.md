# quadMixed Quartus phase reference

Quartus Prime Lite 17.0.2, device `5CSEBA6U23I7`, 50 MHz reference,
4 outputs at 50 MHz, phases 0/5000/15000/17500 ps, 50% duty,
...
1/2/5/6, and phase mux presets 0/4/4/2.
...
```sh
quartus_sh -t /path/to/phase-45/quadMixed/oracle.tcl
