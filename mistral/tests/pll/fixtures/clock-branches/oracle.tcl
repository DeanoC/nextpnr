...
close $sdc
set_location_assignment FRACTIONALPLL_X0_Y15_N0 -to {pll|general[0].gpll~FRACTIONAL_PLL}
set_location_assignment PLLOUTPUTCOUNTER_X0_Y20_N1 -to {pll|general[0].gpll~PLL_OUTPUT_COUNTER}
set_location_assignment CLKCTRL_G3 -to gate
set_location_assignment CLKCTRL_G2 -to {pll|outclk_wire[0]~CLKENA0}
export_assignments
project_close
