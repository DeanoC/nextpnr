# 25/50/80 MHz Quartus reference

Quartus Prime Lite 17.0.2, device `5CSEBA6U23I7`, 50 MHz reference,
25/50/80 MHz outputs, direct integer mode, zero phase, 50% duty.
...
```sh
quartus_sh -t /path/to/fixtures/multi/triple400/oracle.tcl
quartus_sh --flow compile top
mistral-cv decomp 5CSEBA6U23I7 output_files/top.rbf top.bt
```

Counter placement remains constrained to C6 divide16 (8/8), C7 divide8 (4/4), C5 divide5 (3/2, odd-divider even-duty enabled).
