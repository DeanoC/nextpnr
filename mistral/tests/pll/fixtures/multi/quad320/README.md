# 40/80/16/32 MHz Quartus reference

Quartus Prime Lite 17.0.2, device `5CSEBA6U23I7`, 50 MHz reference,
40/80/16/32 MHz outputs, direct integer mode, zero phase, 50% duty.
...
```sh
quartus_sh -t /path/to/fixtures/multi/quad320/oracle.tcl
quartus_sh --flow compile top
mistral-cv decomp 5CSEBA6U23I7 output_files/top.rbf top.bt
```

Counter placement remains constrained to C6 divide8 (4/4), C7 divide4 (2/2), C5 divide20 (10/10), C8 divide10 (5/5).
The complete feedback/analog tuple matches `checked_configs(50)`:
M32/N5, bandwidth6, charge pump2, M low preset4, M phase preset2. Lock filter is hexadecimal019.
