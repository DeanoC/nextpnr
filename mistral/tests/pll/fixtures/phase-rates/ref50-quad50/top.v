module top(input wire FPGA_CLK1_50);
    ...
    altera_pll #(
        ...
        .output_clock_frequency1("50.0 MHz"), .phase_shift1("5000 ps"), .duty_cycle1(50),
        .output_clock_frequency2("50.0 MHz"), .phase_shift2("10000 ps"), .duty_cycle2(50),
        .output_clock_frequency3("50.0 MHz"), .phase_shift3("15000 ps"), .duty_cycle3(50),
