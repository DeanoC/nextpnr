# ref50-triple50 Quartus phase reference

Quartus Prime Lite 17.0.2, device `5CSEBA6U23I7`, 50 MHz reference,
3 outputs at 50 MHz, phases 0/0/15000 ps, 50% duty,
...
1/1/5, and phase mux presets 0/0/4. Default preset1 and phase mux0
...
```sh
quartus_sh -t /path/to/phase-rates/ref50-triple50/oracle.tcl
