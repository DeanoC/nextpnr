# ref25-triple25 Quartus phase reference

Quartus Prime Lite 17.0.2, device `5CSEBA6U23I7`, 25 MHz reference,
3 outputs at 25 MHz, phases 0/0/30000 ps, 50% duty,
...
1/1/10, and phase mux presets 0/0/0. Default preset1 and phase mux0
...
```sh
quartus_sh -t /path/to/phase-rates/ref25-triple25/oracle.tcl
