# ref100-quad320 Quartus reference
...
zero phases in `fitter-pll.txt`. M32/N10, reported VCO 320 MHz.
...
```sh
quartus_sh -t /path/to/fixtures/multi-reference/ref100-quad320/oracle.tcl
