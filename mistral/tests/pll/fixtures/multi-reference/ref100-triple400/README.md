# ref100-triple400 Quartus reference
...
zero phases in `fitter-pll.txt`. M8/N2, reported VCO 400 MHz.
Fixed output counter placements: C6 divide 16 (high 4/low 12), C7 divide 8 (high 4/low 4), C5 divide 4 (high 1/low 3).
The checked feedback tuple uses BWCTRL 7, CP_CURRENT 1, M low preset 1,
...
```sh
quartus_sh -t /path/to/fixtures/multi-reference/ref100-triple400/oracle.tcl
