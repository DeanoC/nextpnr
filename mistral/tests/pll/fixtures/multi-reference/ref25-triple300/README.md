# ref25-triple300 Quartus reference
...
zero phases in `fitter-pll.txt`. M24/N2, reported VCO 300 MHz.
...
```sh
quartus_sh -t /path/to/fixtures/multi-reference/ref25-triple300/oracle.tcl
