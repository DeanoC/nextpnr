# dual100 Quartus phase reference

Quartus Prime Lite 17.0.2, device `5CSEBA6U23I7`, 50 MHz reference,
2 outputs at 100 MHz, phases 0/7500 ps, 50% duty,
...
1/3, and phase mux presets 0/2. Odd-divider even-duty correction
...
```sh
quartus_sh -t /path/to/phase-100/dual100/oracle.tcl
