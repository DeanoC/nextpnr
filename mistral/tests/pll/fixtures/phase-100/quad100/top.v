module top(input wire FPGA_CLK1_50);
    ...
    altera_pll #(
        ...
        .output_clock_frequency1("100.0 MHz"), .phase_shift1("2500 ps"), .duty_cycle1(50),
        .output_clock_frequency2("100.0 MHz"), .phase_shift2("5000 ps"), .duty_cycle2(50),
        .output_clock_frequency3("100.0 MHz"), .phase_shift3("7500 ps"), .duty_cycle3(50),
