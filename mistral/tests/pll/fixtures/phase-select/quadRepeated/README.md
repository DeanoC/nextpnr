# quadRepeated Quartus phase reference

Quartus Prime Lite 17.0.2, device `5CSEBA6U23I7`, 50 MHz reference,
4 outputs at 25 MHz, phases 0/180/180/0 degrees,
...
and presets 1/7/7/1. Zero-phase preset1 is the bitstream default
...
```sh
quartus_sh -t /path/to/phase-select/quadRepeated/oracle.tcl
