# quadPermuted Quartus phase reference

Quartus Prime Lite 17.0.2, device `5CSEBA6U23I7`, 50 MHz reference,
4 outputs at 25 MHz, phases 0/270/90/180 degrees,
...
and presets 1/10/4/7. Zero-phase preset1 is the bitstream default
...
```sh
quartus_sh -t /path/to/phase-select/quadPermuted/oracle.tcl
...
Compilation succeeded with zero errors and 8 warnings (tied reset,
