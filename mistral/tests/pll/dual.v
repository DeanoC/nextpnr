module top(input wire FPGA_CLK1_50);
    ...
    altera_pll #(
        ...
        .output_clock_frequency0("25.0 MHz"), .output_clock_frequency1("40.0 MHz"),
    ...
    assign gpi = {16'hD714, selected_busy, selected_done, selected_lock, selected_lost, reset_sync, 3'b0,
